好的，這是針對 12.9 題的六種策略比較表。題目情境是：投資人預期股價會有**大變動**，但不確定方向。

### 📈 預期大波動但不確定方向 — 策略比較表

| 策略名稱 | 操作方式 (均使用歐式選擇權) | 核心觀念 / 適用時機 | 損益特性摘要 |
| :--- | :--- | :--- | :--- |
| **1. Strangle <br> 勒式組合** | **買進** 1 口價外買權 (K₂) + **買進** 1 口價外賣權 (K₁) <br> (K₂ > K₁) | **成本較低**的波動策略。需要股價突破K₂或跌破K₁才能獲利，門檻比跨式高。 | **風險：** 有限 (付出的權利金) <br> **收益：** 股價大漲或大跌時潛在獲利無限。 |
| **2. Straddle <br> 跨式組合** | **買進** 1 口價平買權 (K) + **買進** 1 口價平賣權 (K) <br> (相同K與T) | **最純粹**的波動策略。股價只要偏離K就能獲利，但成本最高。 | **風險：** 有限 (付出的權利金) <br> **收益：** 股價大漲或大跌時潛在獲利無限。 |
| **3. Strip <br> 偏空跨式** | **買進** 1 口價平買權 (K) + **買進** 2 口價平賣權 (K) | 預期**會有大波動，但下跌可能性略高**於上漲。 | **風險：** 有限 (付出的權利金) <br> **收益：** 下跌時的潛在獲利是上漲時的兩倍。 |
| **4. Strap <br> 偏多跨式** | **買進** 2 口價平買權 (K) + **買進** 1 口價平賣權 (K) | 預期**會有大波動，但上漲可能性略高**於下跌。 | **風險：** 有限 (付出的權利金) <br> **收益：** 上漲時的潛在獲利是下跌時的兩倍。 |
| **5. Reverse Calendar Spread <br> 反轉日曆價差** | **賣出** 1 口短天期選擇權 + **買進** 1 口長天期選擇權 <br> (相同行權價K) | 預期**短期內**就會有大波動，賭短期選擇權的時間價值快速衰減。 | **損益圖複雜**，取決於時間與波動率的變化。通常在近期到期時股價遠離K有最大獲利。 |
| **6. Reverse Butterfly Spread <br> 反轉蝶式價差** | **賣出** 1 口低K選擇權 + **買進** 2 口中K選擇權 + **賣出** 1 口高K選擇權 | 預期**有大波動**，與普通蝶式價差（預期盤整）**相反**。 | **風險：** 無限 (需注意) <br> **收益：** 有限。當股價落在K₁和K₃區間*之外*時獲利。 |
...
1.  **成本比較** (由低到高)：
    Reverse Butterfly → Strangle → Straddle → Strip/Strap

2.  **獲利門檻** (所需波動幅度由大到小)：
    Strangle → Straddle → Strip/Strap → Reverse Calendar/Butterfly (取決於參數)

3.  **風險特性**：
    - Strangle, Straddle, Strip, Strap：風險有限（最大損失為權利金）
    - Reverse Butterfly：風險可能無限，需特別留意。

4.  **方向偏好**：
    - **無偏好**：Strangle, Straddle, Reverse Calendar, Reverse Butterfly
    - **偏空**：Strip
    - **偏多**：Strap

這個表格應該能幫助你快速理解和比較這六種策略的異同。
### **第 1 章 現今全球企業的資訊系統**
